...
# Database connection settings - UPDATE THESE WITH YOUR SUPABASE CREDENTIALS
DB_CONFIG = {
    'host': 'db.ioybnrgdlewvtmetfwea.supabase.co',
    'port': 5432,
    'database': 'postgres',
    'user': 'postgres',
    'password': 'FIFA@0000'
...
def connect_db():
    try:
        ...
        print("Please update the DB_CONFIG in the script with your Supabase credentials.")
        sys.exit(1)
...
def main():
    print("FIFA 26 Player Database Import to Supabase")
    
    # Path to your CSV file
    csv_file = '/Users/naimishmaniya/Documents/Phase3/CSE 412 F26/FC26_20250921.csv'
