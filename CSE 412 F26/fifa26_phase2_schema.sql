-- FIFA 26 Player Management System
...
-- Show table counts
SELECT 
    'COUNTRY' as table_name, COUNT(*) as row_count FROM COUNTRY
...
UNION ALL SELECT 'ADDITIONAL_INFO', COUNT(*) FROM ADDITIONAL_INFO
UNION ALL SELECT 'RATINGS', COUNT(*) FROM RATINGS
UNION ALL SELECT 'player_club', COUNT(*) FROM player_club
UNION ALL SELECT 'player_country', COUNT(*) FROM player_country
UNION ALL SELECT 'player_position', COUNT(*) FROM player_position;
